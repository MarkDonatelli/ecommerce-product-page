<template>
  <div
    class="fixed bottom-0 right-0 flex items-center p-2 m-2 text-sm text-pink-600 bg-gray-300 border border-gray-400 rounded"
  >
    <svg
    ...
    Current breakpoint
    <span class="ml-1 inline xs:hidden sm:hidden md:hidden lg:hidden xl:hidden"
      >default (&lt; 375)</span
    >
    <span class="ml-1 hidden xs:inline sm:hidden md:hidden lg:hidden xl:hidden"
      >xs</span
    >
    <span class="hidden ml-1 font-extrabold sm:inline md:hidden">sm</span>
